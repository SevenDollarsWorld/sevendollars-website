    ...
    <div className="video-detail-page" style={{ background: theme.gradient }}>
      ...
      <div className="video-detail-content text-center px-4">
        ...
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/reel/DGxbtmqThXb/?utm_source=ig_embed&amp;utm_campaign=loading"
...
export default WakeupstyleoneVideo
