  ...
  return (
    <div className="video-detail-page" style={{ background: theme.gradient }}>
      ...
      <div className="video-detail-content text-center px-4">
        <h1>POV:各種舞者的起床方式Part2</h1>
        <p>{t("videoCollection.detailHint")}</p>

        <blockquote
          className="instagram-media"
          data-instgrm-permalink="https://www.instagram.com/reel/DG2movmz1QR/?utm_source=ig_embed&amp;utm_campaign=loading"
...
export default WakeupstyletwoVideo
