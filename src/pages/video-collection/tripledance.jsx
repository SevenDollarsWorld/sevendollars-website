    ...
    <div className="video-detail-page" style={{ background: theme.background }}>
      ...
      <div className="video-detail-content flex flex-col items-center px-4">
        ...
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/reel/DKZPAlATlMu/?utm_source=ig_embed&amp;utm_campaign=loading"
          data-instgrm-version="14"
          style={{ margin: "0 auto", maxWidth: "540px" }}
        ></blockquote>
        <script async src="//www.instagram.com/embed.js"></script>
        <h1 className="text-xl sm:text-2xl font-bold mt-6 text-center">三倍！Choreography</h1>
...
export default TripledanceVideo
