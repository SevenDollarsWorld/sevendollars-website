...
function FreestylewithbrostwoVideo() {
    ...
    <div className="relative w-full">
      ...
      <div className="video-detail-content flex flex-col items-center px-4">
        ...
        <blockquote className="instagram-media"
          data-instgrm-permalink="https://www.instagram.com/reel/DEOoRkiTzaG/?utm_source=ig_embed&amp;utm_campaign=loading"
...
export default FreestylewithbrostwoVideo
