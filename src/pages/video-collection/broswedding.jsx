  ...
  return (
    <div className="video-detail-page" style={{ background: theme.gradient }}>
      ...
      <div className="video-detail-content text-center px-4">
        <h1>POV:當你表哥的婚禮快遲到</h1>
        <p>{t("videoCollection.detailHint")}</p>

        <blockquote
          className="instagram-media"
          data-instgrm-permalink="https://www.instagram.com/reel/C6Bykkhpefa/?utm_source=ig_embed&amp;utm_campaign=loading"
...
export default BrosweddingVideo
