    ...
    <div className="video-detail-page" style={{ background: theme.background }}>
      ...
      <div className="video-detail-content flex flex-col items-center px-4">
        ...
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/reel/DLZm7qLzmuC/?utm_source=ig_embed&amp;utm_campaign=loading"
...
export default FirstrolexVideo
