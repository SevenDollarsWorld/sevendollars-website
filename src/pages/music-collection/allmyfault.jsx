  ...
  <div className="music-detail-page">
    ...
    <div className="music-detail-page">
      <div className="music-detail-content">
        <img src="/allmyfault.jpg" alt="All My Fault Cover" className="music-cover" />
        <h1>All My Fault</h1>
        <p>這裡是介紹內容...</p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/lA6HFzQuIR0?si=xXbPXYZIKs0oaRw" frameBorder="0" allowFullScreen></iframe>
