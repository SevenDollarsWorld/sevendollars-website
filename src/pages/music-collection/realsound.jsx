  ...
  <a href="/contact" className="transition-all px-3 py-1 rounded hover:bg-white hover:text-black hover:font-bold">{t("contact")}</a>
    ...
    <div className="music-detail-page">
      <div className="music-detail-content">
        <img src="/realsound.jpg" alt="Real Sound Cover" className="music-cover" />
        <h1>Real Sound</h1>
        <p>這裡是介紹內容...</p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/nutRYBvtiek?si=tDz0_Pv-NJo7SK1U" frameBorder="0" allowFullScreen></iframe>
