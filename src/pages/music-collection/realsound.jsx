  ...
  return (
    <div className="music-detail-page" style={{ background: theme.background }}>
      ...
      <div className="music-detail-content text-center px-4">
          <img src="/realsound.jpg" alt="Real Sound Cover" className="music-cover mx-auto" />
          <h1>Real Sound</h1>
          <p className="album-description">這裡是介紹內容...</p>
          <iframe className="mx-auto" width="560" height="315" src="https://www.youtube.com/embed/nutRYBvtiek?si=tDz0_Pv-NJo7SK1U" frameBorder="0" allowFullScreen></iframe>
          <iframe style={{ borderRadius: '12px' }} src="https://open.spotify.com/embed/album/5ZncWjxtR7gwFhEy4SgEUu?utm_source=generator" width="100%" height="352" frameBorder="0" loading="lazy"></iframe>
        </div>
