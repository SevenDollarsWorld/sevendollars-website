  ...
  return (
    <div className="music-detail-page" style={{ background: theme.background }}>
      ...
      <div className="music-detail-content text-center px-4">
          <img src="/meteor.jpg" alt="Meteor Cover" className="music-cover mx-auto" />
          <h1>Meteor</h1>
          ...
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/6ZvkRApbIZk?si=iza4UszxvDd2rDbZ"
            frameBorder="0"
            allowFullScreen
          ></iframe>
          <iframe
            style={{ borderRadius: "12px" }}
            src="https://open.spotify.com/embed/album/2JSo7uvGWE1XCWAx3rJ0ft?utm_source=generator"
            width="100%"
            height="352"
            frameBorder="0"
            loading="lazy"
