...
function App() {
  ...
  <Route path="/music-collection/spuintro" element={<SpuintroMusic />} />

  <Route path="/music-collection/neverregret" element={<NeverregretMusic />} />

  <Route path="/music-collection/2am" element={<twoamMusic />} />

  <Route path="/music-collection/wegonbealright" element={<WegonbealrightMusic />} />
  ...
  <Route path="/video-collection/freestylemac" element={<FreestylemacVideo />} />

  <Route path="/video-collection/freestylewithbrostwo" element={<FreestylewithbrostwoVideo />} />

  <Route path="/video-collection/freestylewithbrosone" element={<FreestylewithbrosoneVideo />} />

  <Route path="/video-collection/herewithme" element={<HerewithmeVideo />} />

  <Route path="/video-collection/secretofindustry" element={<SecretofindustryVideo />} />
</Routes>
  );
}
